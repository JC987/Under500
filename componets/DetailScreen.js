    ...
    return (
       <View style={styles.container}>
        ...
        <View style = {styles.title}>
           <Text style = {styles.title}>THIS-IS-10THIS-IS-10THIS-IS-10THIS-IS-10THIS-IS-10THIS-IS-10</Text>
        </View>

        <View style = {styles.author}>
            <Text style = {styles.author}>author's name goes here</Text>
        </View>
        ...
        <View style = {styles.body}>
            ...
            <Text style = {styles.body}>Below is where the 500 page story will go.{"\n"}
                {j}
                {j}
                {j}
                {j}
